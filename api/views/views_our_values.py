...
from api.serializers.serializers_our_values import (
    ValueTabContentCreateUpdateSerializer, ValueTabContentListSerializer,
    ValueTabCreateUpdateSerializer, ValueTabListSerializer,
    ValueTabSectionCreateUpdateSerializer, ValueTabSectionListSerializer)
...
class ValueTabSectionViewSet(BaseAdminViewSet):
    ...
    def by_page(self, request, page_slug=None):
        ...
        value_sections = self.queryset.filter(
