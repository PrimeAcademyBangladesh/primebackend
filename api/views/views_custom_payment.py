...
class CustomPaymentViewSet(BaseAdminViewSet):
    ...
    queryset = CustomPayment.objects.select_related("student", "course", "created_by", "enrollment").all()
    ...
    def mark_completed(self, request, pk=None):
        ...
        return api_response(True, "Payment marked as completed successfully", serializer.data)
