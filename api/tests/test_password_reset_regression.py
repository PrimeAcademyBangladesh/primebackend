...
class PasswordResetRegressionTests(TestCase):
    ...
    def test_consecutive_resets_produce_usable_tokens(self):
        ...
        resp_a = self.client.post(self.password_reset_confirm_url + f'?token={token_a}', {'new_password': 'NewPassA1!', 'new_password2': 'NewPassA1!'}, format='json')
        ...
        resp_b = self.client.post(self.password_reset_confirm_url + f'?token={token_b}', {'new_password': 'NewPassB1!', 'new_password2': 'NewPassB1!'}, format='json')
