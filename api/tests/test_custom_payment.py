...
#
#         # Create course
#         category = Category.objects.create(name="Custom Payment Test Category", slug="cp-test-category")
#
...
#         )
#
#         CoursePrice.objects.create(course=self.course, base_price=Decimal("5000.00"), currency="BDT", is_active=True)
#
...
#             student=self.student1, created_by=self.admin, title="Test Payment", amount=Decimal("1000.00")
#         )
#
...
#             student=self.student1, created_by=self.admin, title="Payment 1", amount=Decimal("1000.00")
#         )
#
#         payment2 = CustomPayment.objects.create(
#             student=self.student1, created_by=self.admin, title="Payment 2", amount=Decimal("2000.00")
#         )
#
...
#         payment = CustomPayment.objects.create(
#             student=self.student1, created_by=self.admin, title="Workshop Fee", amount=Decimal("500.00"), status="pending"
#         )
#
...
#         )
#
#         category = Category.objects.create(name="Integration Test", slug="int-test")
#
#         self.course = Course.objects.create(
...
#         )
#
#         CoursePrice.objects.create(course=self.course, base_price=Decimal("10000.00"), currency="BDT", is_active=True)
#
