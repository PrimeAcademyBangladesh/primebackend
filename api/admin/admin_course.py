...
class CategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Statistics", {"fields": ("courses_count",)}),
        (
            "Timestamps",
...
class CourseAdmin(nested_admin.NestedModelAdmin, BaseModelAdmin):
    ...
    fieldsets = (
        ...
        ("Media", {"fields": (("header_image",), ("header_image_display",))}),
        (
            "Timestamps",
            {"fields": (("created_at",), ("updated_at",)), "classes": ("collapse",)},
        ),
    ...
    actions = [
        "make_show_in_megamenu",
        "remove_show_in_megamenu",
        "make_show_in_home_tab",
        "remove_show_in_home_tab",
    ]
...
class CourseDetailAdmin(BaseModelAdmin):
    ...
    fieldsets = (
        ("Course Link", {"fields": ("id", "course", "is_active")}),
        ("Hero Section", {"fields": ("hero_text", "hero_description", "hero_button")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class CoursePriceAdmin(BaseModelAdmin):
    ...
    fieldsets = (
        ("Course & Currency", {"fields": ("course", "currency", "is_active")}),
        ("Base Pricing", {"fields": ("base_price", "is_free")}),
        (
            "Discount Settings",
            {
                "fields": (
...
class CouponAdmin(BaseModelAdmin):
    ...
    fieldsets = (
        ("Coupon Code", {"fields": ("id", "code", "is_active")}),
        ("Discount Configuration", {"fields": ("discount_type", "discount_value")}),
        ("Applicability", {"fields": ("apply_to_all", "courses")}),
        ("Usage Limits", {"fields": ("max_uses", "used_count", "max_uses_per_user")}),
        (
            "Validity Period",
...
class CourseContentSectionAdmin(BaseModelAdmin):
    ...
    def course_title(self, obj):
        return obj.course_detail.course.title
...
class CourseSectionTabAdmin(BaseModelAdmin):
    ...
    search_fields = (
        ...
        "section__course_detail__course__title",
    )
    list_editable = ("is_active", "order")
...
class CourseTabbedContentAdmin(BaseModelAdmin):
    ...
    search_fields = (
        ...
        "description",
        "tab__tab_name",
        "tab__section__course_detail__course__title",
    )
    list_editable = ("is_active", "order")
    ordering = ("tab", "order")
    ...
    fieldsets = (
        ("Basic Info", {"fields": ("tab", "order", "media_type", "is_active")}),
        (
            "Media",
            {
                "fields": (
...
class WhyEnrolAdmin(BaseModelAdmin):
    list_display = ("title", "course_title", "is_active")
    list_filter = ("is_active",)
    search_fields = ("title", "course_detail__course__title")
...
class SideImageSectionAdmin(BaseModelAdmin):
    list_display = ("title", "course_title", "button_text", "is_active")
    list_filter = ("is_active",)
    search_fields = ("title", "course_detail__course__title")
    list_editable = ("is_active",)
...
class SuccessStoryAdmin(BaseModelAdmin):
    list_display = ("name", "course_title", "is_active")
    list_filter = ("is_active",)
    search_fields = ("name", "course_detail__course__title")
    list_editable = ("is_active",)
...
class CourseInstructorAdmin(BaseModelAdmin):
    ...
    def instructor_type_display(self, obj):
        colors = {"lead": "#2e7d32", "support": "#1976d2", "assistant": "#f57c00"}
