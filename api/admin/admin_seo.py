...
class PageSEOAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Page Identification", {"fields": ("page_name", "is_active")}),  # Added is_active
        ("Basic SEO Meta", {"fields": ("meta_title", "meta_description", "meta_keywords")}),
        ("Open Graph (Facebook & LinkedIn)", {"fields": ("og_title", "og_description", "og_image", "og_type", "og_url")}),
        (
            "Twitter Card",
            {
                "fields": (
        ...
        ("Advanced SEO", {"fields": ("canonical_url", "robots_meta", "structured_data")}),
