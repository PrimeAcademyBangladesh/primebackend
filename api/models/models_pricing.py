...
class CoursePrice(TimeStampedModel):
    ...
    is_free = models.BooleanField(
        default=False,
        help_text="Mark as free course (overrides all pricing)"
    )
    ...
    installment_available = models.BooleanField(
        default=False,
        help_text="Whether installment payment is available"
    )
    installment_count = models.PositiveIntegerField(
        null=True, 
        blank=True,
        help_text="Number of installments allowed"
    )
    ...
    def is_currently_discounted(self):
        ...
        has_discount = (
            (self.discount_percentage and self.discount_percentage > 0) or 
...
class Coupon(TimeStampedModel):
    ...
    code = models.CharField(
        ...
        unique=True,
        db_index=True,
        help_text="Unique coupon code (e.g., SAVE20, NEWSTUDENT)"
    )
    ...
    apply_to_all = models.BooleanField(
        default=False,
        help_text="Apply to all courses (overrides specific course selection)"
    )
    ...
    max_uses = models.PositiveIntegerField(
        null=True, 
        blank=True,
        help_text="Maximum total uses (leave empty for unlimited)"
    )
