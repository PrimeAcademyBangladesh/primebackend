...
class HeroSection(TimeStampedModel, OptimizedImageModel):
    ...
    id = models.UUIDField(
        ...
        default=uuid.uuid4,
        editable=False,
        help_text="Unique UUID identifier for this hero section."
    )
    ...
    title = models.CharField(
        ...
        blank=True, 
        null=True,
        help_text="Main headline text (max 255 chars) displayed in the hero section."
    )

    description = models.TextField(
        blank=True, 
        null=True,
        help_text="Subtitle or description text below the main title."
    )    
    ...
    button1_text = models.CharField(
        ...
        blank=True, 
        null=True,
        help_text="Text for the primary call-to-action button (max 100 chars)."
    )
    ...
    button2_text = models.CharField(
        ...
        blank=True, 
        null=True,
        help_text="Text for the secondary call-to-action button (max 100 chars)."
    )
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Uncheck to hide this hero section from the website."
    )
...
class HeroSlideText(TimeStampedModel):
    ...
    id = models.UUIDField(
        ...
        default=uuid.uuid4,
        editable=False,
        help_text="Unique UUID identifier for this slide text."
    )
    ...
    text = models.CharField(
        max_length=255,
        help_text="Text to display in the animated slide (max 255 chars)."
    )
    order = models.PositiveIntegerField(
        default=0,
        help_text="Display order (0=first, 1=second, etc.). Lower numbers show first."
    )
...
class Brand(TimeStampedModel, OptimizedImageModel):
    ...
    id = models.UUIDField(
        ...
        default=uuid.uuid4,
        editable=False,
        help_text="Unique UUID identifier for this brand."
    )
    logo = models.ImageField(
        upload_to="brands_logo/", 
        help_text="Brand logo image. Recommended size: 400x400px with transparent background."
    )
    is_active = models.BooleanField(
        default=True, 
        help_text="Uncheck to hide this brand from the website display."
    )
