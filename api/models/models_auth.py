...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    id = models.UUIDField(
        ...
        default=uuid.uuid4,
        editable=False,
        help_text="Unique UUID identifier for this user."
    )
    ...
    first_name = models.CharField(
        _('first name'), 
        max_length=150,
        help_text="User's first name (max 150 chars)."
    )
    last_name = models.CharField(
        _('last name'), 
        max_length=150,
        help_text="User's last name (max 150 chars)."
    )
    ...
    phone = models.CharField(
        ...
        max_length=15, 
        unique=True,
        help_text="Unique phone number (max 15 chars). Include country code."
    )
    last_password_reset = models.DateTimeField(
        null=True, 
        blank=True,
        help_text="Timestamp of the last password reset. Auto-managed by system."
    )
    ...
    is_staff = models.BooleanField(
        default=False, 
        help_text=_('Check to allow admin site access. Staff can log into admin panel.')
    )
    is_active = models.BooleanField(
        default=True, 
        help_text=_('Uncheck to disable account. Inactive users cannot log in.')
    )
...
class Skill(models.Model):
    ...
    id = models.UUIDField(
        ...
        default=uuid.uuid4,
        editable=False,
        help_text="Unique UUID identifier for this skill."
    )
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Uncheck to hide this skill from selection options."
    )
...
class Profile(TimeStampedModel, OptimizedImageModel):
    ...
    id = models.UUIDField(
        ...
        default=uuid.uuid4,
        editable=False,
        help_text="Unique UUID identifier for this profile."
    )
    ...
    skills = models.ManyToManyField(
        Skill, 
        blank=True,
        help_text="Select skills associated with this user. Hold Ctrl/Cmd to select multiple."
    )
