...
class Course(TimeStampedModel, OptimizedImageModel):
    ...
    show_in_megamenu = models.BooleanField(
        default=False,
        help_text="Whether to display this course in the megamenu"
    )
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this course is active and visible"
    )
...
class CourseDetail(TimeStampedModel):
    ...
    hero_text = models.TextField(
        help_text="Hero section text content"
    )
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this course detail is active"
    )
...
class CourseSectionTab(models.Model):
    ...
    tab_name = models.CharField(
        max_length=100,
        help_text="Name of this tab (shown as tab header)"
    )
    order = models.PositiveIntegerField(
        default=0,
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this tab is active and visible"
    )
...
class CourseTabbedContent(TimeStampedModel, OptimizedImageModel):
    ...
    title = models.CharField(
        max_length=255,
        blank=True,
        help_text="Title of this content item"
    )
    description = CKEditor5Field(
        blank=True,
        help_text="Rich text description/content"
    )
    ...
    button_link = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Optional button link"
    )
    ...
    order = models.PositiveIntegerField(
        default=0,
        help_text="Display order within the tab"
    )
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this content is active and visible"
    )
...
class CourseModule(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    course = models.ForeignKey(
        CourseDetail, related_name="modules", on_delete=models.CASCADE
    )
    title = models.CharField(max_length=100)
    short_description = CKEditor5Field(
        help_text="Rich text description of the module"
    )
    order = models.PositiveIntegerField()
    is_active = models.BooleanField(
        default=True,
...
class CourseInstructor(models.Model):
    ...
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this instructor assignment is currently active"
    )
    assigned_date = models.DateTimeField(
        auto_now_add=True,
        help_text="Date when instructor was assigned to this course"
    )
...
class KeyBenefit(OptimizedImageModel):
    ...
    title = models.CharField(max_length=100)
    text = CKEditor5Field(
        help_text="Rich text description of the benefit"
    )
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this benefit is active and visible"
    )
...
class SideImageSection(OptimizedImageModel):
    ...
    text = CKEditor5Field(
        help_text="Rich text content for the side section"
    )
    button_text = models.CharField(max_length=100, blank=True)
    button_url = models.URLField(blank=True)
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this side image section is active and visible"
    )
...
class SuccessStory(OptimizedImageModel):
    ...
    description = CKEditor5Field(
        help_text="Rich text description of the success story"
    )
    name = models.CharField(max_length=100)
    is_active = models.BooleanField(
        default=True,
        help_text="Whether this success story is active and visible"
    )
