...
class ContentSection(TimeStampedModel, OptimizedImageModel):
    ...
    page = models.ForeignKey(
        PageService, on_delete=models.CASCADE, related_name="content_sections"
    )
    ...
    position_choice = models.CharField(
        ...
        default='top',
        help_text="Position of the section on the page."
    )
    ...
    media_type = models.CharField(
        ...
        choices=MEDIA_TYPES,
        default='image',
        help_text="Choose between image or video for Info Sections"
    )
    ...
    video_provider = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Select video provider (YouTube or Vimeo)"
    )
