...
class EnrollmentDetailSerializer(EnrollmentSerializer):
    ...
    class Meta(EnrollmentSerializer.Meta):
        fields = EnrollmentSerializer.Meta.fields + ['course_info', 'course_status', 'module_count']
    ...
    def get_module_count(self, obj):
        ...
        if hasattr(obj.course, 'detail'):
            return obj.course.detail.modules.filter(is_active=True).count()
        return 0
