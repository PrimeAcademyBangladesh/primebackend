...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("api", "0013_remove_quizquestion_question_image"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.SlugField(
                default="", help_text="URL-friendly module identifier", max_length=120
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="coursemodule",
            index=models.Index(
                fields=["course", "slug"], name="api_coursem_course__9eb5a3_idx"
            ),
        ),
    ]
